<x-app-layout>
    ...
    <x-table.search-header :url="route('users.index')">
        <div>
            ...
            <p class="text-gray-500 text-sm">Kelola akun administrator, pegawai, gudang, dan pimpinan.</p>
        </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @php
                                    $roleColor = match ($u->role) {
                                        ...
                                        'Gudang' => 'bg-orange-100 text-orange-800 border-orange-200',
                                        'Pimpinan' => 'bg-green-100 text-green-800 border-green-200',
                                        default => 'bg-gray-100 text-gray-800 border-gray-200',
                                    };
                                @endphp
                                <span
                                    class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full border {{ $roleColor }}">
                                    {{ $u->role }}
                                </span>
                            </td>
